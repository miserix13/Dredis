...
- Cuckoo filter: `CF.RESERVE`, `CF.ADD`, `CF.ADDNX`, `CF.EXISTS`, `CF.DEL`, `CF.COUNT`, `CF.INFO`
- t-digest: `TDIGEST.CREATE`, `TDIGEST.RESET`, `TDIGEST.ADD`, `TDIGEST.QUANTILE`, `TDIGEST.CDF`, `TDIGEST.MIN`, `TDIGEST.MAX`, `TDIGEST.INFO`
...
| Cuckoo filter | Yes | `CF.RESERVE`, `CF.ADD`, `CF.ADDNX`, `CF.EXISTS`, `CF.DEL`, `CF.COUNT`, `CF.INFO` |
| t-digest | Yes | `TDIGEST.CREATE`, `TDIGEST.RESET`, `TDIGEST.ADD`, `TDIGEST.QUANTILE`, `TDIGEST.CDF`, `TDIGEST.MIN`, `TDIGEST.MAX`, `TDIGEST.INFO` |
